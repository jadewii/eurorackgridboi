...
async function loadProducts() {
    ...
    console.log('printifyProducts exists?', typeof printifyProducts !== 'undefined');
    ...
    if (typeof printifyProducts !== 'undefined') {
        ...
        if (productGrid) {
            productGrid.innerHTML = '<p>Found ' + products.length + ' products, displaying...</p>';
        }
    } else {
        console.log('printifyProducts not found, using sample products');
        try {
...
function displayProducts(category = 'all', page = 1) {
    ...
    console.log('Displaying products:', products.length, 'Category:', category);
    ...
    // Display products
    console.log('Paginated products to display:', paginatedProducts.length);
    ...
    if (paginatedProducts.length === 0) {
        ...
        paginatedProducts.forEach((product, index) => {
            console.log('Creating card', index + 1, 'for', product.title);
            try {
...
function createProductCard(product) {
    ...
    infoDiv.innerHTML = `
        <h3 class="product-title" onclick="if(typeof openProductModal === 'function') openProductModal('${product.id}')" style="cursor: pointer;">${product.title}</h3>
